...
> **上游：** [`minibot-fastapi-migration.md`](./minibot-fastapi-migration.md) Phase 10、[`minibot-core-impact.md`](./minibot-core-impact.md) Phase 10 表格
...
**工程文档 `docs-plan/`：**
- 本文件：Phase 10 权威计划
- [`minibot-fastapi-migration.md`](./minibot-fastapi-migration.md) Phase 10：改写为摘要 + 指向本文件
...
| `docs-plan/minibot-fastapi-migration.md` | Phase 10 改写为摘要 |
...
- [`docs/configuration.md:162-192`](../docs/configuration.md) — Langfuse 章节可整段移植到 `docs/observability.md`
...
- nanobot [`docs/configuration.md`](../docs/configuration.md) Langfuse Observability 章节
