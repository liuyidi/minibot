...
> **For agentic workers:** Implement task-by-task; checkbox steps. Spec: absorbed into code + migration.md
...
- Align WS event names with client-api.md / nanobot-client (`delta`, `stream_end`, `reasoning_delta`, `reasoning_end`).
...
**Files:** `docs/migration.md`, this file status
