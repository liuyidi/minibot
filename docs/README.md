...
| [`plans/`](./plans/) | 待执行切片计划（如 [Chrome 扩展 2026-08-25](./plans/2026-08-25-chrome-extension.md)、[今日 2026-08-18](./plans/2026-08-18-daily.md)、[API GET→POST](./plans/api-mutation-post-body.md)） |
