...
| minibot FastAPI (local WebUI backend) | [`server.md`](./server.md) | Replacement runtime on `:8766`; migration status table |
| minibot migration roadmap | [`../docs-plan/minibot-fastapi-migration.md`](../docs-plan/minibot-fastapi-migration.md) | Phased rewrite plan for WebUI/Gateway backend parity |
