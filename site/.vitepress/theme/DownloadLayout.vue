...
const messages = {
  "zh-CN": {
    ...
    "subtitle":
      "Web、Android 与桌面端（macOS / Windows / Linux）共用同一套身份与会话；iOS 可先通过 TestFlight 体验。",
    "primary": "打开 Web App",
    "benefitNoInstall": "Web 无需安装",
    "benefitSync": "会话持续同步",
    "benefitPrivate": "连接自己的 minibot",
    "platformTitle": "选择适合你的设备",
    "platformSubtitle": "Web App、Android 与桌面端现已可下载；iOS 可经 TestFlight 安装。",
    "mobileTitle": "移动 App",
    "desktopTitle": "桌面 App",
    "iosBody": "支持 iOS 14.0 及更高版本的操作系统。",
    "iosFooter": "客户端正在准备上架 App Store，可先通过 TestFlight 安装体验。",
    ...
    "scanToDownload": "扫码下载",
    "cli.title": "更想用 CLI？",
    "cli.body": "Node.js ≥ 18。npm 全局安装后登录即可对话，默认连接 bot.liuyidi.me（与 Web / Desktop 同一套身份）。",
    "cli.installLabel": "安装",
    "cli.startLabel": "登录并聊天",
    "cli.note": "适合本机终端、服务器与 SSH。自建 Gateway 见 CLI 说明。",
    "cli.more": "查看 CLI 说明 →",
    "cli.copy": "复制",
    "cli.copied": "已复制",
  ...
  en: {
    ...
    "subtitle":
      "Web, Android, and desktop (macOS / Windows / Linux) share the same identity and sessions. iOS is available via TestFlight.",
    ...
    "platformSubtitle": "Web, Android, and desktop are ready; iOS installs via TestFlight.",
    "mobileTitle": "Mobile app",
    "desktopTitle": "Desktop app",
    "iosBody": "Requires iOS 14.0 or later.",
    "iosFooter": "Preparing for the App Store — try TestFlight first.",
    ...
    "cli.body": "Requires Node.js ≥ 18. Install globally with npm, log in, and chat — defaults to bot.liuyidi.me (same identity as Web / Desktop).",
    "cli.installLabel": "Install",
    "cli.startLabel": "Login and chat",
    "cli.note": "Works on your laptop, servers, and over SSH. See CLI docs for a self-hosted Gateway.",
    "cli.more": "CLI docs →",
    "cli.copy": "Copy",
    "cli.copied": "Copied",
