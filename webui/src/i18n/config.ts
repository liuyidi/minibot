export const LOCALE_STORAGE_KEY = "minibot.locale";
...
/** Languages exposed in the WebUI switcher (full resource packs remain for tests). */
export const switchableLocales = supportedLocales.filter(
  (locale) => locale.code === "zh-CN" || locale.code === "en",
);
