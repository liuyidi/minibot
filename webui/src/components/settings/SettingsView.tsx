...
import { ProviderIcon, ProviderPicker } from "@/components/settings/model-pickers";
...
const LOCAL_PREFS_STORAGE_KEY = "minibot-webui.settings-preferences";
  ...
  return (
    <div className="space-y-7">
      <section>
        ...
        <SettingsGroup>
          <SettingsRow title={tx("settings.rows.botName", "Bot name")} description={tx("settings.help.botName", "Shown wherever minibot uses a display name.")}>
            <Input
              value={form.botName}
          ...
          <RestartSettingsFooter
            ...
            dirtyMessage={
              isNativeHost
                ? tx("settings.status.hostRestartAfterSaving", "Save changes and minibot will restart its engine.")
                : tx("settings.status.restartAfterSaving", "Save changes, then restart when ready.")
            }
            pendingMessage={
              isNativeHost
