  ...
  return (
    ...
    >
      {goalPanelOpen && canExpandGoal && markdownBody ? (
        <div
          ref={panelRef}
          id="minibot-goal-panel-root"
          role="dialog"
          aria-modal="false"
          aria-labelledby="minibot-goal-panel-title"
          tabIndex={-1}
          className={cn(
      ...
      >
        ...
        {canExpandGoal ? (
          <button
            ...
            aria-controls={goalPanelOpen ? "minibot-goal-panel-root" : undefined}
